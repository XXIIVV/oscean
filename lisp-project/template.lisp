...
; (dom:set-html _glyph "<path d='M90.0,90.0 L90.0,90.0 L150.0,150.0 L90.0,210.0 M210.0,90.0 L210.0,90.0 L210.0,210.0'></path>")
...
(defn display-photo (res) (
  ...
  (dom:set-html _photo "<media id='media' style='background-image: url(../media/diary/1C.jpg)'></media>")
