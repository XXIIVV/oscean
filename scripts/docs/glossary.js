var payload = new Runic(`~ Arguments
...
- From omniscience : An arguer would need omniscience to know about everyone's beliefs or disbeliefs or about their knowledge.  : {*Example*}: All people believe in something. Everyone knows that.
...
~ Types
- Straw man : Creating a false or made up scenario and then attacking it. Painting your opponent with false colors only deflects the purpose of the argument. : {*Example*}: Evolutionists think that everything came about by random chance.
...
- Fully general counterargument : An argument which can be used to discount any conclusion the arguer does not like. Being in possession of such an argument leads to irrationality because it allows the arguer to avoid updating their beliefs.  : {*Example*}: You're just saying that because you're exhibiting X bias.
