...
- Context effect : That cognition and memory are dependent on context, such that out-of-context memories are more difficult to retrieve than in-context memories.  : {*Example*}: Recall time and accuracy for a work-related memory will be lower at home, and vice versa.
...
- Fallacy of gray : {*Assumption*} that because nothing is certain, everything is equally uncertain. It does not take into account that some things are more certain than others. : {*The Sophisticate*}: "The world isn't black and white. No one does pure good or pure bad. Therefore, no one is better than anyone else." {*The Zetet*}: "Knowing only gray, you conclude that all grays are the same shade. You mock the simplicity of the two-color view, yet you replace it with a one-color view."
...
`); invoke.vessel.seal("docs","biases",payload);
