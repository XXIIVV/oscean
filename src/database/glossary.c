...
add_word(&reading_list_2016, "Predictable Irrational", "Dan Ariely");
add_word(&reading_list_2016, "How Not To Die", "Michael Greger");
add_word(&reading_list_2016, "The China Study", "T. Colin Campbell");
add_word(&reading_list_2016, "Letter To My Father", "Franz Kafka");
add_word(&reading_list_2016, "Le Ton Beau De Marot", "Douglas Hofstadter");
add_word(&reading_list_2016, "Beyond Good & Evil", "Friedrich Nietzche");
add_word(&reading_list_2016, "The Circle", "Dave Eggers");
 
Dict reading_list_2017 = create_dict("reading list 2017");
add_word(&reading_list_2017, "Pictures From The Water Trade", "John David Morley");
add_word(&reading_list_2017, "A Calendar Of Wisdom", "Tolstoy");
add_word(&reading_list_2017, "The Art Of War", "Sun Tzu");
add_word(&reading_list_2017, "Superintelligence", "Nick Bostrom");
add_word(&reading_list_2017, "Kokoro", "Natsume Soseki");
add_word(&reading_list_2017, "From AI To Zombies", "Eliezer Yudkowsky");
add_word(&reading_list_2017, "In Praise Of Darkness", "Jorge Luis Borges");
add_word(&reading_list_2017, "Self-Sufficient Sailor", "Lin Pardey");
add_word(&reading_list_2017, "Travels in Hyperreality", "Umberto Eco");
add_word(&reading_list_2017, "North To The Night", "Alvah Simon");
add_word(&reading_list_2017, "Smoke Gets In Your Eyes", "Caitlin Doughty");
add_word(&reading_list_2017, "The Fungi Of Yuggot", "H. P. Lovecraft");
add_word(&reading_list_2017, "In The Dust Of This Planet", "Eugene Thacker");
add_word(&reading_list_2017, "The Japanese Art of Decluttering", "Marie Kondo");
add_word(&reading_list_2017, "Zen and the Art of Motorcycle Maintenance", "Robert M. Pirsig");
add_word(&reading_list_2017, "Meditations", "Marcus Aurelius");
 
Dict reading_list_2018 = create_dict("reading list 2018");
add_word(&reading_list_2018, "Hermeneutics", "John D. Caputo");
add_word(&reading_list_2018, "Tao Te Ching", "Lao Tzu");
add_word(&reading_list_2018, "Letters From A Stoic", "Seneca");
add_word(&reading_list_2018, "Animal Farm", "George Orwell & Russel Baker");
add_word(&reading_list_2018, "Last Chance to See", "Douglas Adams & Mark Carwardine");
add_word(&reading_list_2018, "The Arabian Nights", "Anonymous");
add_word(&reading_list_2018, "The Stack", "Benjamin H. Bratton");
add_word(&reading_list_2018, "The Futurological Congress", "Stanislaw Lem");
add_word(&reading_list_2018, "The Handmaid's Tale", "Margaret Atwood");
add_word(&reading_list_2018, "The Cyberiad", "Stanislaw Lem");
add_word(&reading_list_2018, "Ishmael", "Daniel Quinn");
add_word(&reading_list_2018, "Godforsaken Sea", "Derek Lundy");
add_word(&reading_list_2018, "The Tao Of Pooh", "Benjamin Hoff");
add_word(&reading_list_2018, "The Te Of Piglet", "Benjamin Hoff");
add_word(&reading_list_2018, "The Book Of Five Rings", "Miyamoto Musashi");
add_word(&reading_list_2018, "Hagakure", "Tsunetomo Yamamoto");
add_word(&reading_list_2018, "Don't Sleep There Are Snakes", "Daneil L. Everett");
add_word(&reading_list_2018, "On Trails", "Robert Moor");
add_word(&reading_list_2018, "The Sixth Extinction", "Elizabeth Kolbert");
add_word(&reading_list_2018, "The Empty Mirror", "Janwillem Van De Wetering");
add_word(&reading_list_2018, "Industrial Society and Its Future", "Theodore Kaczynski");
add_word(&reading_list_2018, "Animal Liberation", "Peter Signer");
add_word(&reading_list_2018, "On Food and Cooking", "Harold McGee");
add_word(&reading_list_2018, "Finite and Infinite Games", "James P. Carse");
 
Dict reading_list_2019 = create_dict("reading list 2019");
add_word(&reading_list_2019, "Who Owns The Future", "Jaron Lanier");
add_word(&reading_list_2019, "Practical Ethics", "Peter Signer");
add_word(&reading_list_2019, "Cyclonopedia", "Reza Negarestani");
add_word(&reading_list_2019, "Embassytown", "China Miéville");
add_word(&reading_list_2019, "The Art of UNIX Programming", "Eric S. Raymond");
add_word(&reading_list_2019, "Xenofeminism", "Helen Hester");
add_word(&reading_list_2019, "Land Of Lisp", "Conrad Barski");
add_word(&reading_list_2019, "The Word for World is Forest", "Ursula K. Le Guin");
add_word(&reading_list_2019, "The Accelerationist Reader", "Robin Mackay");
add_word(&reading_list_2019, "Collected Shorts", "H. P. Lovecraft");
add_word(&reading_list_2019, "Assemblage Theory", "Manuel DeLanda");
add_word(&reading_list_2019, "Rasselas", "Samuel Johnson");
add_word(&reading_list_2019, "Inventing the Future", "Nick Srnicek");
add_word(&reading_list_2019, "The Golden Apples of the Sun", "Ray Bradbury");
add_word(&reading_list_2019, "Manuel De Résistance Contemporaine", "Cyril Dion");
add_word(&reading_list_2019, "Girls Last Tour", "Tsukumizu");
...
add_word(&reading_list_2020, "Dracula", "Bram Stoker");
add_word(&reading_list_2020, "Des choses cachées depuis la fondation du monde", "René Girard");
add_word(&reading_list_2020, "Tamata et l'alliance", "Bernard Moitessier");
