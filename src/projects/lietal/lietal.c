...
void lietal_dictionarystr(char *src, char *dest) {
  int len = strlen(src);
  substr(src, dest, 0, len);
}

void lietal_adultsegstr(char *src, char *dest) {
...
void lietal_casualsegstr(char *src, char *dest) {
  char c1 = src[0], v1 = src[1], c2 = src[2], v2 = src[3];
  substr(src, dest, 0, 4);
  if (c1 == c2 && v1 == v2) {
    dest[0] = v1;
...
void lietal_mixedsegstr(char *src, char *dest) {
  char c1 = src[0], v1 = src[1], c2 = src[2], v2 = src[3];
  substr(src, dest, 0, 4);
  if (c1 == c2 && v1 == v2) {
    dest[0] = v1;
...
void lietal_formalsegstr(char *src, char *dest) {
  char c1 = src[0], v1 = src[1], c2 = src[2], v2 = src[3];
  substr(src, dest, 0, 4);
  if (c1 == c2 && v1 == v2) {
    dest[2] = 'e';
...
void lietal_adultstr(char *src, char *dest) {
  if (strlen(src) == 2) {
    substr(src, dest, 0, 2);
...
void lietal_casualstr(char *src, char *dest) {
  if (strlen(src) == 2) {
    dest[0] = src[1];
    dest[1] = src[0];
    dest[2] = '\0';
...
void lietal_mixedstr(char *src, char *dest) {
  if (strlen(src) == 2) {
    dest[0] = src[1];
    dest[1] = src[0];
    dest[2] = '\0';
...
void lietal_formalstr(char *src, char *dest) {
  if (strlen(src) == 2) {
    substr(src, dest, 0, 2);
  } else if (strlen(src) == 4) {
