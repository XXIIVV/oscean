...
add_quote(&quotes, "There is no future. There is no past. <b>Time</b> is simultaneous, an intricately structured jewel that humans insist on viewing one edge at a time, when the whole design is visible in every facet.", "undefinedThere is no future. There is no past. Time is simultaneous, an intricately structured jewel that humans insist on viewing one edge at a time, when the whole design is visible in every facet.","Alan Moore, Watchmen");
...
add_quote(&es, "The Victorious Ones have announced that " SENDNAME(buddhism_path, "emptiness") " is the relinquishing of all views. Those who are possessed of the view of emptiness are said to be incorrigible.", "undefinedThe Victorious Ones have announced that emptiness is the relinquishing of all views. Those who are possessed of the view of emptiness are said to be incorrigible.", "Verse, Mūlamadhyamakakārikā");
add_header(&es, "God Eternally Geometrizes");
add_quote(&es, "No limiting qualities <br />are to be attributed to the <b>Absolute</b>.", "undefinedNo limiting qualities <br />are to be attributed to the Absolute.", "Plutarch, Convivalium Disputationum libri novem");
