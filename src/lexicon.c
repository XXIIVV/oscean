...
add_text(&routine, "The day ends with " SENDNAME("journal", "journaling") " at which point I record the task done, and if any, the " SENDNAME("mirrors", "lessons learnt") ". I usually go to sleep with a " SENDNAME("directory", "book") ", and a highlighter pen. I overline the things I want to keep for a later use, or to revisit.");
