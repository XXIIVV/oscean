...
Term nataniev_time = create_index("time", "Documentation on the different Time formats.");
set_parent(&nataniev_time, &nataniev);
add_html(&nataniev_time, MODFRAME("https://clock.xxiivv.com"));

Term neralie = create_term("neralie", "Neralie is a decimal time format.");
set_parent(&neralie, &nataniev_time);
...
set_parent(&arvelie, &nataniev_time);
...
Term ethics = create_term("ethics", "A collection of notes on various topics concerning ethics.");
...
Term vegan = create_term("vegan", "A cheatsheet on various tropes against vegan discourse.");
set_parent(&vegan, &ethics);

Term technology = create_term("technology", "A cheatsheet on various topics of technology.");
set_parent(&technology, &mirrors);
