...
Term vast = create_album("vast", "Vast is the first book of Elodie Lareine, a manual of procedural imagery.");
...
Term defraction_optics = create_album("defraction optics", "Defraction Optics is the second book of Elodie Lareine, a manual of procedural imagery, in the fashion of Vast.");
...
Term thousand_rooms = create_album("thousand rooms", "Thousand Rooms is a visual novel.");
...
Term wallpapers = create_album("wallpapers", "Collection of Wallpapers related to Nataniev and Horaire.");
